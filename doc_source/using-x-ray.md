...
**Note**  
For each traced invocation, Lambda emits the Lambda service segment and all of its subsegments\. These segments and subsegments are emitted regardless of the runtime you use\.
